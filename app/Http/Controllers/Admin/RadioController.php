...
class RadioController extends Controller
{
    ...
    public function index(Request $request)
    {
        try {
            ...
            $query = Content::where('content_type', 6);
            if ($input_search) {
    ...
    public function edit($id)
    {
        try {
            ...
            if ($params['data'] != null) {
                ...
                return view('admin.radio.edit', $params);
            } else {
    ...
    public function show($id)
    {
        try {
            ...
            return redirect()->route('admin.radio.index')->with('success', __('label.radio_delete'));
        } catch (Exception $e) {
            return response()->json(['status' => 400, 'errors' => $e->getMessage()]);
        }
    }
    ...
    public function saveChunk()
    {
        ...
        if (!$chunks || $chunk == $chunks - 1) {
            ...
            $newFileName = 'radio' . date('_Y_m_d_') . uniqid() . '.' . $extension; // Use the extracted extension
