...
class HomeController extends Controller
{
    ...
    public function get_section_list(Request $request) // type = 1-Song, 2-Podcat, 3-Live Event, 4-Artist, 5-Category, 6-Language, 7-City, 8-Music
    {
        try {
            ...
            $data = Section::whereIn('user_id', [0, $user_id])->where('section_type', $section_type)->where('status', 1)->orderBy('is_pinned', 'desc')->orderByRaw('user_id=? DESC', [$user_id])->orderBy('sortable', 'asc');
    ...
    public function get_podcast_section_list(Request $request)
    {
        try {
            ...
            $data = Section::whereIn('user_id', [0, $user_id])->where('section_type', 4)->where('status', 1)->orderBy('is_pinned', 'desc')->orderByRaw('user_id=? DESC', [$user_id])->orderBy('sortable', 'asc');
    ...
    public function get_radio_section_list(Request $request)
    {
        try {
            ...
            $data = Section::whereIn('user_id', [0, $user_id])
                ...
                ->orderBy('is_pinned', 'desc')->orderByRaw('user_id=? DESC', [$user_id])->orderBy('sortable', 'asc');
