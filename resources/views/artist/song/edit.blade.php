        ...
        <div class="card custom-border-card">
            <form id="song_form" autocomplete="off" enctype="multipart/form-data">
                ...
                <div class="form-row">
                    <div class="col-md-8">
                        ...
                        <div class="form-row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Song File <small class="text-muted">(leave empty to keep current)</small></label>
                                    <input type="file" name="song_url" class="form-control" accept="audio/*">
                                    <input type="hidden" name="old_song_url" value="{{ $data->song_url }}">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group ml-5">
                            <label>Image <small class="text-muted">(leave empty to keep current)</small></label>
                            <div class="avatar-upload">
                                ...
                                <div class="avatar-preview">
                                    <img src="{{ $data->image }}" alt="song image" id="imagePreview" style="height:100%; width:100%; object-fit:cover;">
                                </div>
                            </div>
                ...
                <div class="border-top pt-3 text-right">
                    <button type="button" class="btn btn-default mw-120" onclick="update_song()">Update</button>
...
@section('pagescript')
    <script>
        ...
        function update_song() {
            ...
            $.ajax({
                type: 'POST',
                url: '{{ route("artist.songs.update", [$data->id]) }}',
                data: formData,
                cache: false,
                contentType: false,
                processData: false,
