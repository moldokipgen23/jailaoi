                ...
                <table width="540" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:16px;box-shadow:0 6px 24px rgba(0,0,0,0.06);overflow:hidden;">
                    <tr>
                        <td style="background:linear-gradient(135deg,#10b981 0%,#059669 100%);padding:32px 30px;text-align:center;">
                            ...
                            <p style="color:#fff;opacity:0.9;margin:6px 0 0;font-size:13px;text-transform:uppercase;letter-spacing:1.5px;">KYC Verification</p>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding:36px 36px 30px;">
                            <h2 style="margin:0 0 14px;font-size:20px;color:#1a1a1a;">KYC Approved, {{ $name }}!</h2>
                            <p style="margin:0 0 18px;color:#444;line-height:1.6;font-size:15px;">
                                Your identity verification has been approved. You are now eligible to withdraw your earnings from JailaOi.
                            </p>
                            <p style="text-align:center;margin:28px 0;">
                                <a href="{{ url('/user/earnings') }}" style="display:inline-block;background:#10b981;color:#fff;padding:14px 34px;border-radius:10px;text-decoration:none;font-weight:600;font-size:15px;">
                                    View Earnings
                                </a>
                            </p>
                        </td>
