                ...
                <table width="540" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:16px;box-shadow:0 6px 24px rgba(0,0,0,0.06);overflow:hidden;">
                    <tr>
                        <td style="background:linear-gradient(135deg,#E01E75 0%,#c41a66 100%);padding:32px 30px;text-align:center;">
                            ...
                            <p style="color:#fff;opacity:0.9;margin:6px 0 0;font-size:13px;text-transform:uppercase;letter-spacing:1.5px;">Payout</p>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding:36px 36px 30px;">
                            ...
                            <div style="background:#f0faf0;border-radius:10px;padding:20px;margin:20px 0;">
                                <table width="100%" cellpadding="6">
                                    ...
                                    <tr>
                                        <td style="color:#888;font-size:14px;">Method</td>
                                        <td style="text-align:right;font-size:14px;color:#1a1a1a;">{{ ucfirst($paymentMethod) }}</td>
                                    </tr>
                                    @if($reference)
                                    <tr>
                                        <td style="color:#888;font-size:14px;">Reference</td>
                                        <td style="text-align:right;font-size:14px;color:#1a1a1a;">{{ $reference }}</td>
                                    </tr>
                                    @endif
                                </table>
                            </div>
