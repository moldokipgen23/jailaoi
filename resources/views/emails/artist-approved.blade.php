                ...
                <table width="540" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:16px;box-shadow:0 6px 24px rgba(0,0,0,0.06);overflow:hidden;">
                    ...
                    <tr>
                        <td style="padding:36px 36px 30px;">
                            <h2 style="margin:0 0 14px;font-size:20px;color:#1a1a1a;">Congratulations, {{ $name }}!</h2>
                            <p style="margin:0 0 18px;color:#444;line-height:1.6;font-size:15px;">
                                Your artist application for <strong>{{ $artistName }}</strong> has been approved! You now have access to the full artist portal.
                            </p>
                            <p style="text-align:center;margin:28px 0;">
                                <a href="{{ $loginUrl }}" style="display:inline-block;background:#E01E75;color:#fff;padding:14px 34px;border-radius:10px;text-decoration:none;font-weight:600;font-size:15px;">
                                    Log in to Artist Portal
                                </a>
                            </p>
                            <p style="margin:0 0 10px;color:#444;line-height:1.6;font-size:15px;">
                                From your dashboard you can upload music, manage your profile, and track your earnings.
                            </p>
                        </td>
                    </tr>
                    <tr>
