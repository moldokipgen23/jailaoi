                    ...
                    <form id="fbad">
                        ...
                        <div class="row">
                            <div class="col-12 col-sm-6 col-md-4">
                                ...
                                <div class="form-group">
                                    <label>Reward video Status Ad Click</label>
                                    <input type="text" name="fb_reward_adclick" class="form-control" value="{{$result['fb_reward_adclick']}}" placeholder="Enter Reward Ad Click">
                                </div>
                            </div>
                            <div class="col-12 col-sm-6 col-md-4">
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="fb_interstital_adclick" class="form-control" value="{{$result['fb_interstital_adclick']}}" placeholder="Enter Interstital Ad Click">
                                </div>
                            </div>
                        </div>
                    ...
                    <form id="fbad_ios">
                        ...
                        <div class="row">
                            <div class="col-12 col-sm-6 col-md-4">
                                ...
                                <div class="form-group">
                                    <label>Reward video Status Ad Click</label>
                                    <input type="text" name="fb_ios_reward_adclick" class="form-control" placeholder="Enter Reward Ad Click" value="{{$result['fb_ios_reward_adclick']}}">
                                </div>
                            </div>
                            <div class="col-12 col-sm-6 col-md-4">
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label>Interstital Ad Click</label>
                                    <input type="text" name="fb_ios_interstital_adclick" class="form-control" placeholder="Enter Interstital Ad Click" value="{{$result['fb_ios_interstital_adclick']}}">
                                </div>
                            </div>
                        </div>
                        <div class="border-top pt-3 text-right">
