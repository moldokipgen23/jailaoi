                            ...
                            <div class="form-row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="full_name" class="form-control" placeholder="Enter Your Name" autofocus>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="mobile_number" min="0" class="form-control" placeholder="Enter Mobile Number">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>{{__('Label.country_name')}}<span class="text-danger">*</span></label>
                                        <input type="text" name="country_name" class="form-control" placeholder="{{__('Label.enter_country_name')}}">
                                    </div>
                                </div>
                            </div>
                        </div>
