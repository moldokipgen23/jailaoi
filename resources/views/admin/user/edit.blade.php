							...
							<div class="form-row">
								<div class="col-md-4">
									<div class="form-group">
										...
										<input type="text" value="@if($data){{$data->full_name}}@endif" name="full_name" class="form-control" placeholder="Enter Your Name">
									</div>
								</div>
								<div class="col-md-4">
									<div class="form-group">
										<label>{{__('Label.Mobile Number')}}<span class="text-danger">*</span></label>
										<input type="text" value="@if($data){{$data->mobile_number}}@endif" name="mobile_number" min="0" class="form-control" placeholder="Enter Mobile Number">
									</div>
								</div>
								<div class="col-md-4">
									<div class="form-group">
										<label>{{__('Label.Email')}}<span class="text-danger">*</span></label>
										<input type="email" value="@if($data){{$data->email}}@endif" name="email" class="form-control" placeholder="Enter Your Email">
									</div>
								</div>
							</div>
							<div class="form-row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label> {{__('Label.Mobile Number')}}<span class="text-danger">*</span></label>
                                        <input type="text" value="@if($data){{$data->mobile_number}}@endif" name="mobile_number" class="form-control " placeholder=" {{__('Label.enter_mobile_number')}}">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                     <div class="form-group">
                                         <label>{{__('Label.country_name')}}<span class="text-danger">*</span></label>
                                         <input type="text" value="@if($data){{$data->country_name}}@endif" name="country_name" class="form-control" placeholder="{{__('Label.enter_country_name')}}">
                                     </div>
                                 </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select name="role" class="form-control">
                                            ...
                                            <option value="artist" @if($data && $data->role == 'artist') selected @endif>Artist</option>
                                            <option value="admin" @if($data && $data->role == 'admin') selected @endif>Admin</option>
                                        </select>
                                    </div>
                                </div>
							</div>
