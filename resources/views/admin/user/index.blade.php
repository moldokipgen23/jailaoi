    ...
    <div class="body-content">
        ...
        <div class="border-bottom row mb-3">
            ...
            <div class="col-sm-2 d-flex align-items-center justify-content-end mb-3">
                <a href="{{ route('user.create') }}" class="btn btn-default mw-120">{{__('label.add_user')}}</a>
            </div>
        </div>
        <!-- Export Files -->
        <div class="page-search mb-3">
            ...
            <div class="col-4">
                <div class="d-flex justify-content-around">
                    ...
                    <button id="csv" class="btn btn-default" title="Download CSV"><i class="fa-solid fa-file-csv mr-2 font-weight-bold"></i>{{__('label.csv')}}</button>
                    <button id="pdf" class="btn btn-default" title="Download PDF"><i class="fa-solid fa-file-pdf mr-2 font-weight-bold"></i>{{__('label.pdf')}}</button>
                </div>
            </div>
        </div>
        <!-- search -->
        <div class="page-search mb-3">
            <div class="input-group">
                ...
                <input type="text" id="input_search" class="form-control" placeholder="{{__('label.search_user')}}" aria-label="Search" aria-describedby="basic-addon1">
            </div>
            <div class="sorting mr-4 w-40">
                <label>Sort by :</label>
