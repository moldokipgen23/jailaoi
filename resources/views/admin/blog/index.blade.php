...
@section('content')
    ...
    <div class="right-content">
        ...
        <div class="body-content">
            <h1 class="page-title-sm">Blog</h1>
                ...
                <div class="card-body">
                    <form id="blog" enctype="multipart/form-data">
                        ...
                        <div class="form-row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="title" class="form-control" placeholder="Enter Blog Title" autofocus>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Content</label>
                                    <textarea name="content" class="form-control" rows="5" placeholder="Blog Content (HTML supported)"></textarea>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group ml-5">
                                    <label class="ml-5">Thumbnail</label>
                        ...
                        <div class="border-top pt-3 text-right">
                            <button type="button" class="btn btn-default mw-120" onclick="save_blog()">{{__('Label.SAVE')}}</button>
            ...
            <div class="card custom-border-card mt-3">
                <div class="page-search mb-3">
                    <div class="input-group" title="Search">
                        ...
                        <input type="text" id="input_search" class="form-control" placeholder="Search Blog" aria-label="Search" aria-describedby="basic-addon1">
                    </div>
                </div>
            ...
            <div class="modal fade" id="EditModel" tabindex="-1" data-backdrop="static" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        <form id="edit_blog" autocomplete="off">
                            <div class="modal-body">
                                <div class="form-row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Title<span class="text-danger">*</span></label>
                                            <input type="text" name="title" id="edit_title" class="form-control" placeholder="Enter Blog Title">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-default mw-120" onclick="update_blog()">{{__('Label.UPDATE')}}</button>
...
@section('pagescript')
    <script>
        ...
        function save_blog() {
            ...
            if (Check_Admin == 1) {
                $("#dvloader").show();
                var formData = new FormData($("#blog")[0]);
                $.ajax({
                    type: 'POST',
                    ...
                    success: function(resp) {
                        $("#dvloader").hide();
                        get_responce_message(resp, 'blog', '{{ route("blog.index") }}');
                    },
        ...
        $(document).on("click", ".edit_blog", function() {
            ...
            $(".modal-body #edit_tags").val($(this).data('tags'));
            $(".modal-body #edit_description").val($(this).data('description'));
            $(".modal-body #edit_content").val($(this).data('content'));
        ...
        function update_blog() {
            ...
            if (Check_Admin == 1) {
                $("#dvloader").show();
                var formData = new FormData($("#edit_blog")[0]);
                ...
                $.ajax({
                    ...
                    success: function(resp) {
                        ...
                        get_responce_message(resp, 'edit_blog', '{{ route("blog.index") }}');
                    },
                    error: function(XMLHttpRequest, textStatus, errorThrown) {
                        $("#dvloader").hide();
                        toastr.error(errorThrown, textStatus);
