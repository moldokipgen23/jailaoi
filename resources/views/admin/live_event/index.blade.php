...
@section('page_title', __('Label.live_evenet'))
...
@section('content')
    ...
    <div class="right-content">
        ...
        <div class="body-content">
            <!-- mobile title -->
            <h1 class="page-title-sm">{{__('Label.live_evenet')}}</h1>

            <div class="border-bottom row mb-3">
                <div class="col-sm-12">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">{{__('Label.Dashboard')}}</a></li>
                        <li class="breadcrumb-item active" aria-current="page">{{__('Label.live_evenet')}}</li>
                    </ol>
                </div>
            </div>
            ...
            <div class="card custom-border-card mt-3">
                <h5 class="card-header">{{__('Label.add_live_evenet')}}</h5>
                <div class="card-body">
            ...
            <div class="card custom-border-card mt-3">
                <div class="page-search mb-3">
                    <div class="input-group" title="Search">
                        ...
                        <input type="text" id="input_search" class="form-control" placeholder="Search Live Event" aria-label="Search" aria-describedby="basic-addon1">
                    </div>
                </div>
                ...
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Edit Live Event</h5>
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Start Time<span class="text-danger">*</span></label>
                                            <input type="text" name="start_time" id="edit_start_time" class="form-control timePicker" placeholder="Start Time">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>End Time<span class="text-danger">*</span></label>
                                            <input type="text" name="end_time" id="edit_end_time" class="form-control timePicker" placeholder="Start Time">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
