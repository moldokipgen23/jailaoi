            ...
            <div class="border-bottom row mb-3">
                <div class="col-sm-10">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('admin.video.index') }}">{{__('label.videos')}}</a></li>
                        <li class="breadcrumb-item active" aria-current="page">{{__('label.edit_video')}}</li>
                    </ol>
                </div>
                <div class="col-sm-2 d-flex align-items-center justify-content-end">
                    <a href="{{ route('admin.video.index') }}" class="btn btn-default mw-120" style="margin-top:-14px">{{__('label.video_list')}}</a>
                </div>
            </div>
            ...
            <form id="video" enctype="multipart/form-data">
                ...
                <div class="card custom-border-card mt-3">
                            ...
                            <div class="form-row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="content_upload_type" id="content_upload_type">
                                            <option value="server_video" {{ $data['content_upload_type'] == "server_video" ? 'selected' : ''}}>{{__('label.server_video')}}</option>
                                            <option value="external_url" {{ $data['content_upload_type'] == "external_url" ? 'selected' : ''}}>{{__('label.external_url')}}</option>
                                            <option value="youtube" {{ $data['content_upload_type'] == "youtube" ? 'selected' : ''}}>{{__('label.youtube')}}</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-2 mt-4 video_box">
                                    <div class="form-group mt-3">
                                        <a id="upload" class="btn text-white primary-bg">{{__('label.upload_file')}}</a>
                                    </div>
                                </div>
                            ...
                            <div class="form-row rent_price">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="rent_price" value="@if($data['is_rent'] == '1'){{{$data['rent_price']}}}@endif" class="form-control" placeholder="{{__('label.price_here')}}" min="0">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label>{{__('label.rent_time_in_days')}}<span class="text-danger">*</span></label>
                                        <input type="number" name="rent_day" value="@if($data['is_rent'] == '1'){{{$data['rent_day']}}}@endif" class="form-control" placeholder="{{__('label.enter_day')}}" min="0">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="border-top pt-3 text-right">
                        <button type="button" class="btn btn-default mw-120" onclick="save_video()">{{__('label.update')}}</button>
                        <a href="{{ route('admin.video.index') }}" class="btn btn-cancel mw-120 ml-2">{{__('label.cancel')}}</a>
