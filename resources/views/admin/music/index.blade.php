        ...
        <div class="body-content">
            ...
            <div class="border-bottom row mb-3">
                ...
                <div class="col-sm-2 d-flex align-items-center justify-content-end">
                    <a href="{{ route('admin.music.create') }}" class="btn btn-default mw-120" style="margin-top: -14px;">{{__('label.add_music')}}</a>
                </div>
            </div>
                        ...
                        <div class="position-relative">
                            ...
                            <ul class="list-inline overlap-control" aria-labelledby="dropdownMenuLink">
                                <li class="list-inline-item">
                                    <a class="btn" href="{{route('admin.music.edit', [$value->id])}}">
