    ...
    <div class="right-content">
        ...
        <div class="body-content">
            ...
            <div class="card custom-border-card mt-3">
                ...
                <div class="card-body">
                    <form id="category" enctype="multipart/form-data" autocomplete="off">
    ...
    <script>
        ...
        function sortOrderBTN() {
            ...
            for (var i = 0; i < category_data.length; i++) { 
                htmlContent += '<div id="'+ category_data[i].id +'" class="listitemClass mb-2" style="background-color: #e9ecef; border: 1px solid black; cursor: s-resize;">' +
