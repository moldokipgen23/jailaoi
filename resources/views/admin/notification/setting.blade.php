                ...
                <div class="form-row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>{{__('label.onesignal_app_id')}}</label>
                            <input name="onesignal_apid" type="text" class="form-control" value="@if($result){{$result['onesignal_apid']}}@endif" placeholder="{{__('label.onesignal_app_id_here')}}">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>{{__('label.onesignal_rest_key')}}</label>
                            <input name="onesignal_rest_key" type="text" class="form-control" value="@if($result){{$result['onesignal_rest_key']}}@endif" placeholder="{{__('label.onesignal_rest_key_here')}}">
                        </div>
                    </div>
                </div>
