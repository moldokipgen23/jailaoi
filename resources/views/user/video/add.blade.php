            ...
            <div class="border-bottom row mb-3">
                <div class="col-sm-10">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">{{__('label.add_video')}}</li>
                    </ol>
                </div>
                            ...
                            <div class="form-row rent_price">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="rent_price" class="form-control" placeholder="{{__('label.price_here')}}" min="0">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label>{{__('label.rent_time_in_days')}}<span class="text-danger">*</span></label>
                                        <input type="number" name="rent_day" class="form-control" placeholder="{{__('label.enter_day')}}" min="0">
                                    </div>
                                </div>
                            </div>
                        </div>
