            ...
            <div class="border-bottom row mb-3">
                <div class="col-sm-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('user.playlist.index') }}">{{__('label.playlists')}}</a></li>
    ...
    <script>
        ...
        $("#content_type").change(function() {
            ...
            if(content_type == 1 || content_type == 2 || content_type == 4 || content_type == 6){
                ...
                $.ajax({
                    ...
                    type: 'post',
                    url: '{{ route("user.playlist.get.content") }}',
        ...
        function save_content(){
            ...
            if(Demo_Mode == 1){
                ...
                $.ajax({
                    type:'POST',
                    url:'{{ route("user.playlist.content.save") }}',
                    data:formData,
                    cache:false,
                    contentType: false,
                    processData: false,
                    success:function(resp){
                        $("#dvloader").hide();
                        get_responce_message(resp, 'content', '{{ route("user.playlist.content.index", $playlist_id) }}');
                    },
                    error: function(XMLHttpRequest, textStatus, errorThrown) {
                        $("#dvloader").hide();
                        toastr.error(errorThrown, textStatus);
        ...
        function delete_content(id){
            ...
            if(Demo_Mode == 1){
                ...
                $.ajax({
				    ...
				    enctype: 'multipart/form-data',
                    type: 'POST',
                    url: '{{ route("user.playlist.content.delete") }}',
        ...
        function getIdsOfContent() {
            ...
            if(Demo_Mode == 1){
                ...
                $.ajax({
				    ...
				    enctype: 'multipart/form-data',
                    type: 'POST',
                    url: '{{ route("user.playlist.content.sort_order") }}',
                    data: {ids:values},
                    success: function(resp) {
                        toastr.success(resp.success);
                    },
