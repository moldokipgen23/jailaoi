...
@section('tab_title', __('label.music'))
        ...
        <div class="body-content">
            ...
            <div class="border-bottom row mb-3">
                ...
                <div class="col-sm-2 d-flex align-items-center justify-content-end">
                    <a href="{{ route('user.music.create') }}" class="btn btn-default mw-120" style="margin-top: -14px;">{{__('label.add_music')}}</a>
                </div>
            </div>

            <!-- Search -->
            <form action="{{ route('user.music.index')}}" method="GET">
                        ...
                        <div class="position-relative">
                            ...
                            <ul class="list-inline overlap-control" aria-labelledby="dropdownMenuLink">
                                <li class="list-inline-item">
                                    <a class="btn" href="{{route('user.music.edit', [$value->id])}}">
                                        <i class="fa-solid fa-pen-to-square fa-xl primary-color" class="dot-icon"></i>
                                    </a>
                                </li>
                                <li class="list-inline-item">
                                    <a class="btn" href="{{route('user.music.show', [$value->id])}}" onclick="return confirm('{{__('label.delete_music')}}')">
