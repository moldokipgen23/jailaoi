...
Route::group(['middleware' => 'apipurchasecode'], function () {
    ...
    // -------------------- ArtistController (Profile & Artist Features) --------------------
    Route::post('get_user_profile', [ArtistController::class, 'get_user_profile']);
    Route::post('get_artist_profile', [ArtistController::class, 'get_artist_profile']);
    Route::post('get_artist_songs', [ArtistController::class, 'get_artist_songs']);
    Route::post('get_user_songs', [ArtistController::class, 'get_user_songs']);
    ...
    Route::post('get_followers', [ArtistController::class, 'get_followers']);
    Route::post('get_following', [ArtistController::class, 'get_following']);
    Route::post('get_artist_dashboard', [ArtistController::class, 'get_artist_dashboard']);
    Route::post('get_artists', [ArtistController::class, 'get_artists']);
